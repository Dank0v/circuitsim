            ...
            CREATIVE_MODE_TABS.register("circuitsim_tab", () ->
                    CreativeModeTab.builder()
                            ...
                            .displayItems((parameters, output) -> {
                                ...
                                output.accept(ModItems.LOOP_PROBE.get());
                                ...
                                output.accept(ModItems.DISCRETE_NPN.get());
                                output.accept(ModItems.DISCRETE_PNP.get());
                                ...
                                output.accept(ModItems.TRANSFORMER.get());
                                output.accept(ModItems.TRANSMISSION_LINE.get());
